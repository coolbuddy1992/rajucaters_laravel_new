                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <form action="{{ route('categories.update', $category) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <h5>Category Name HI <span class="text-danger">*</span></h5>
                                <div class="controls">
                                    <input type="text" value="{{ old('category_name_hi', $category->category_name_hi) }}" name="category_name_hi" class="form-control" required="" data-validation-required-message="This field is required"> <div class="help-block"></div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <img src="{{$category->category_image}}" height="100" width="100"> <div class="help-block"></div>
                                </div>
                                <div class="controls">

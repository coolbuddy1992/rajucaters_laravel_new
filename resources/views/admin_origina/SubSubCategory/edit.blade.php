                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <form action="{{ route('subsubcategories.update', $subsubCategory) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <h5>Sub Sub-Category Name HI <span class="text-danger">*</span></h5>
                                <div class="controls">
                                    <input type="text" value="{{ old('subsubcategory_name_hi', $subsubCategory->subsubcategory_name_hi) }}" name="subsubcategory_name_hi" class="form-control" required="" data-validation-required-message="This field is required"> <div class="help-block"></div>
                                </div>
                                @error('subsubcategory_name_hi')
                                    <span class="alert text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                <h5>Sub subcategory Image</h5>
                                <div class="controls">
                                    <img src="{{asset($subsubCategory->subsubcategory_image)}}" height="100" width="100"> <div class="help-block"></div>
                                </div>
                                <div class="controls">
                                    <input type="file" name="subsubcategory_image" class="form-control"> <div class="help-block"></div>
                                </div>

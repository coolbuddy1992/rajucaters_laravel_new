                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="product_size_hi" class="form-control" value="small,medium,large" data-role="tagsinput">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="product_color_hi" class="form-control" value="red,green,blue" data-role="tagsinput"><div class="help-block"></div>
                                        </div>

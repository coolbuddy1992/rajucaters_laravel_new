                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="product_size_hi" value="{{ old('product_size_hi', $product->product_size_hi) }}"
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="product_color_hi" value="{{ old('product_color_hi', $product->product_color_hi) }}"
                                            class="form-control" data-role="tagsinput"><div class="help-block"></div>
                                        </div>

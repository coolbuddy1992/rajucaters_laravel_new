                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <form action="{{ route('subcategories.update', $subcategory) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <h5>Sub Category Name HI <span class="text-danger">*</span></h5>
                                <div class="controls">
                                    <input type="text" value="{{ old('subcategory_name_hi', $subcategory->subcategory_name_hi) }}" name="subcategory_name_hi" class="form-control" required="" data-validation-required-message="This field is required"> <div class="help-block"></div>
                                </div>
                            ...
                            <div class="form-group">
                                <h5>Sub category Image </h5>
                                <div class="controls">
                                    <img src="{{$subcategory->subcategory_image}}" height="100" width="100"> <div class="help-block"></div>
                                </div>
                                <div class="controls">
                                    <input type="file" name="subcategory_image" class="form-control"> <div class="help-block"></div>
                                </div>

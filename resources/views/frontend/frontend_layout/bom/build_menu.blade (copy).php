                              ...
                              @foreach($categories as $category)
                                <fieldset class="menu_stepform">
                                  <div class="tab-menu">
                                    ...
                                    <input type="button" name="previous" class="previous action-button-previous @if($i==1) hide @endif {{$i}}" value="Previous" />
                                </fieldset>
                              @endforeach
                             <fieldset>
                                  <div class="form-card">
            ...
            <div class="col col-sm-12 col-md-6">
              <div class="search-result-container menutablecontainer">
                  @foreach($bom_detail as $build_own_menu)
                    ...
                    @endforeach
                    <button class="btn btn-primary book-now-btn" id="book_now" data-id="{{$build_own_menu->id}}"> Book Now </button>
                  @endforeach
                @endif
              </div>
            </div>

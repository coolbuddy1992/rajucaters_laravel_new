<div class="sidebar-module-container">
    <div class="sidebar-filter">
        <!--  SIDEBAR CATEGORY  -->
        <div class="sidebar-widget wow fadeInUp animated hide" style="visibility: visible; animation-name: fadeInUp;">
        ...
        <!--  COLOR: END  -->
        <!--  COMPARE -->
        <div class="sidebar-widget wow fadeInUp outer-top-vs animated hide"

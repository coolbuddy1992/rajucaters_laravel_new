                        ...
                        <form action="{{ route('gallery.update', $gallery) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-4">
                                <div class="form-check form-switch">
                                    ...
                                    id="status" name="gallery_status" value="1" {{ $gallery->gallery_status == 1 ? 'checked': '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="gallery_name" value="{{ old('gallery_name', $gallery->photo_name) }}"
                            ...
                            <div class="form-group">
                                ...
                                @error('gallery_image')
                                    <span class="alert text-danger">{{ $message }}</span>
                                @enderror
                                <img src="{{ $gallery->photo_location}}" id="galleryImage" alt="" width="100" height="100">
                            </div>

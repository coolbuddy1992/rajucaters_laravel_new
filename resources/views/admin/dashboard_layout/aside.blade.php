...
<section class="sidebar">
        ...
        <div class="ulogo">
                ...
                <!-- logo for regular state and mobile devices -->
                    <div class="d-flex align-items-center justify-content-center">
                        <img src="{{!empty($adminSetting->website_logo) ? $adminSetting->website_logo : ''}}" alt="{{$adminSetting->website_title}}" width="50" height="50">
                        <h3><b>{{ Auth::guard('admin')->user()->name }}</b> Admin</h3>
                    </div>
            </a>
        </div>
    </div>
    ...
    <li class="treeview {{ ($route == 'buildOwnMenu.index') ? 'active' : '' }}">
        <a href="#">
        <i data-feather="message-circle"></i>
        <span>Build Own Menu</span>
        <span class="pull-right-container">
            <i class="fa fa-angle-right pull-right"></i>
        </span>
        </a>
        <ul class="treeview-menu">
        <li class=" {{ ($route == 'buildOwnMenu.index') ? 'active' : '' }}">
            <a href="{{ route('buildOwnMenu.index') }}"><i class="ti-more"></i>All Menu</a>
        </li>
        </ul>
    </li>
    ...
    <li class="treeview {{ ($prefix == '/gallery') ? 'active' : '' }}">
        <a href="#">
        <i data-feather="file"></i> <span>Gallery</span>
        <span class="pull-right-container">
            <i class="fa fa-angle-right pull-right"></i>
        </span>
        </a>
        <ul class="treeview-menu">
            <li class=" {{ ($route == '/gallery') ? 'active' : '' }}">
                <a href="{{ route('gallery.index') }}"><i class="ti-more"></i>Gallery Slider</a>
            </li>
        </ul>
    </li>
    <li class="treeview {{ ($prefix == '/review') ? 'active' : '' }}">
        <a href="#">
        <i data-feather="file"></i> <span>Review</span>
        <span class="pull-right-container">
            <i class="fa fa-angle-right pull-right"></i>
        </span>
        </a>
        <ul class="treeview-menu">
            <li class=" {{ ($route == '/review') ? 'active' : '' }}">
                <a href="{{ route('admin.review') }}"><i class="ti-more"></i>Review</a>
            </li>
        </ul>
    </li>

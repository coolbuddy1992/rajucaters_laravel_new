...
<nav class="navbar navbar-static-top pl-30">
    ...
    <ul class="nav navbar-nav">
        ...
        <a href="#" class="waves-effect waves-light rounded dropdown-toggle p-0" data-toggle="dropdown" title="User">
            <img class="rounded-circle" src="{{!empty($adminSetting->website_logo) ? $adminSetting->website_logo : ''}}" alt="User Avatar">
        ...
        <ul class="dropdown-menu animated flipInX">
            <li class="user-body">
                ...
                <a class="dropdown-item" href="{{route('admin.setting')}}"><i class="ti-settings text-muted mr-2"></i> Settings</a>

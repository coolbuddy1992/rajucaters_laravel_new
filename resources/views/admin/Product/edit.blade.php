                    ...
                    <div class="box-body">
                        <form action="{{ route('products.update', $product) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                @if (!empty($product->sub_subcategory_id)) {
                                    <div class="col-md-3">
                                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="product_name_hi" value="{{ old('product_name_hi', $product->product_name_hi) }}"
                                            class="form-control" required="" data-validation-required-message="This field is required"> <div class="help-block"></div>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="product_tags_hi" value="{{ old('product_tags_hi', $product->product_tags_hi) }}"
                                            class="form-control" data-role="tagsinput"> <div class="help-block"></div>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="short_description_hi" id="editor2" cols="30" rows="5" class="form-control">
                                                {{ old('short_description_hi', $product->short_description_hi) }}
                                            </textarea>
                                            <div class="help-block"></div>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="long_description_hi" id="editor4" cols="30" rows="5" class="form-control">
                                                {{ old('long_description_hi', $product->long_description_hi) }}
                                            </textarea>
                                            <div class="help-block"></div>
                                        </div>
            ...
            <div class="col-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        @else
                        <form method="POST" action="{{ route('update-product-image-new') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="file" name="product_images[]" class="form-control"  multiple="" id="multiImgNew" > <div class="help-block"></div>
                                    </div>
...
<script type="text/javascript">
    ...
    // image add
    $('#multiImgNew').on('change', function(){ //on file input change
        if (window.File && window.FileReader && window.FileList && window.Blob) //check File API supported browser
        {
            var data = $(this)[0].files; //this file data

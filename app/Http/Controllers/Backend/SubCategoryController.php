...
class SubCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.SubCategory.index', compact('subCategories', 'adminSetting'));
    }
    ...
    public function create()
    {
        ...
        $adminSetting = Admin_Setting::find(1);
        return view('admin.SubCategory.create', compact('categories', 'adminSetting'));
    }
    ...
    public function edit(SubCategory $subcategory)
    {
        $categories = Category::latest()->get();
        $adminSetting = Admin_Setting::find(1);
        return view('admin.SubCategory.edit', compact('subcategory', 'categories', 'adminSetting'));
    }
    ...
    public function destroy($id)
    {
        ...
        $subCategoryImageRemove = (new FileUploadController)->deleteImage($subCategory->public_id);

        if($subCategoryImageRemove){
            $subCategory->delete();

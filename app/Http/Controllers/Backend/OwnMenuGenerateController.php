...
class OwnMenuGenerateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.PerosonalMenuGenerate.create', compact('getMenu', 'categories', 'adminSetting'));
    }
    ...
    public function showMenuDetail($menuId)
    {
        ...
        $adminSetting = Admin_Setting::find(1);
        return view('admin.PerosonalMenuGenerate.index', compact('bml', 'adminSetting'));  
    }
    ...
    public function showMenuListDetail($menu_id)
    {
        ...
        $adminSetting = Admin_Setting::find(1);
        return view('admin.PerosonalMenuGenerate.showMenuList', compact('bml', 'adminSetting'));
